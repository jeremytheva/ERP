...
export const ALL_TASKS: Task[] = [
  ...
  {
    id: "PM-2-2",
    title: "Validated BOM Change (Round 2+)",
  ...
  {
    id: "PM-2-3",
    title: "Run MRP, Set Lot Size, Release (Round 2+)",
  ...
  {
    id: "PM-2-4",
    title: "Execution Lock Confirm (Round 2+)",
  ...
  {
    id: "PM-2-5",
    title: "Capacity & Cost Efficiency (Round 2+)",
