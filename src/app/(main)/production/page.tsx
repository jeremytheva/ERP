            ...
            <CardContent>
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                    <TabsList className="grid w-full grid-cols-4">
                        <TabsTrigger value="planning-capacity"><FileBox className="mr-2 h-4 w-4" />Planning & Capacity</TabsTrigger>
                        <TabsTrigger value="mrp"><Wrench className="mr-2 h-4 w-4" />MRP (MD01)</TabsTrigger>
                        <TabsTrigger value="production-release"><PackageCheck className="mr-2 h-4 w-4" />Production Release (CO41)</TabsTrigger>
                        <TabsTrigger value="bom-review"><FileSignature className="mr-2 h-4 w-4" />BOM Review (ZCS02)</TabsTrigger>
                    </TabsList>
