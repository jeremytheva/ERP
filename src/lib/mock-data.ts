...
export const ALL_TASKS: Task[] = [
  ...
  ...Array.from({ length: 7 }, (_, i) => i + 2).flatMap(round => [
    ...
    },
    {
        ...
        description: "Review final cash balance (ZFF7B) to ensure no red cash alert is triggered right at the final minute. If Financial Stability (Liquidity) is active, check with Sales if transfers are on track and prioritize stock transfer to high-volume/fast-paying DCs.",
        role: "Logistics" as Role,
