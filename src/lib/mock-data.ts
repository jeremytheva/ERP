...
export const ALL_TASKS: Task[] = [
  ...
  },
  {
    ...
    description: "Focus: Finished Goods Stock, Capacity Used, Defect Rate. Check for Overstock if Finished Goods > 100,000 units. Prepares for Lot Size Decision (PM-X-4).",
    role: "Production",
  ...
  },
  {
    ...
    description: "Check/Change Product Design for the current round.",
    role: "Production",
    transactionCode: "ZCS02",
    priority: "Medium",
    estimatedTime: 2,
  ...
  },
  {
    ...
    description: "Focus: Cash Balance, Total Profit, Accounts Receivable (AR). CF: Red if Cash Balance < €100,000.",
    role: "Logistics",
